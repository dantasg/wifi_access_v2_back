...
/// <summary>
/// Configurações do portal (tema + parâmetros de acesso). Linha única na tabela —
/// o Id é sempre <see cref="SingletonId"/>.
/// </summary>
public class PortalSettings
{
    ...
    /// <summary>Tempo de liberação do guest — substitui o Unifi:AccessMinutes do appsettings.</summary>
